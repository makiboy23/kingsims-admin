							...
							<div class="row">
								<div class="col-xl-3">
									<div class="form-group">
										...
										<input name="username" class="form-control" placeholder="Username" value="<?=isset($post['username']) ? $post['username'] : ""?>" <?=isset($is_update) ? "disabled" : ""?>>
							...
							<div class="row">
								<div class="col-xl-3">
									<div class="form-group">
										...
										<input type="password" name="password" class="form-control" value="<?=isset($post['password']) ? $post['password'] : ""?>">
								...
								<div class="col-xl-3">
									<div class="form-group">
										...
										<input type="password" name="repeat-password" class="form-control" value="<?=isset($post['repeat-password']) ? $post['repeat-password'] : ""?>">
