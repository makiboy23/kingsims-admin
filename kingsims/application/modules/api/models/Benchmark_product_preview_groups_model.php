...
class Benchmark_product_preview_groups_model extends CI_Model {
	private 
		$_table	= 'benchmark_product_preview_groups benchmark_product_preview_groups',
		$_table_x	= 'benchmark_product_preview_groups';
	...
	function replace( $data ) {
		$this->db->replace( $this->_table_x , $data);
	}

	function truncate() {
		$this->db->truncate($this->_table_x);
	}
